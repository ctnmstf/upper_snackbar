      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildButton(context, 'Show Success', Colors.green, () {
            ...
            _buildButton(context, 'Show Error', Colors.red, () {
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'Show Warning', Colors.orange, () {
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'Show Info', Colors.blue, () {
            ...
            const SizedBox(height: 12),
            _buildButton(context, 'Snackbar with Action', Colors.purple, () {
              UpperSnackbar().showSuccess(
                context,
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'Rounded Corners', Colors.amber, () {
              UpperSnackbar().show(
                context,
                message: 'Extra rounded corners',
                type: SnackbarType.warning,
                style: const SnackbarStyle(borderRadius: 30.0),
              );
            }),
            const SizedBox(height: 8),
            _buildButton(context, 'Without Close Icon', Colors.brown, () {
              UpperSnackbar().showInfo(
                context,
            ...
            const SizedBox(height: 12),
            _buildButton(context, 'Long Duration (5s)', Colors.green, () {
              UpperSnackbar().showSuccess(
                context,
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'Short Duration (1s)', Colors.red, () {
              UpperSnackbar().showError(
                context,
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'Slow Animation', Colors.blue, () {
              UpperSnackbar().show(
                context,
            ...
            const SizedBox(height: 12),
            _buildButton(context, 'Non-dismissible', Colors.red.shade900, () {
              UpperSnackbar().show(
                context,
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'With Tap Callback', Colors.deepPurple, () {
              UpperSnackbar().showInfo(
                context,
            ...
            const SizedBox(height: 8),
            _buildButton(context, 'Long Text Example', Colors.blueGrey, () {
              UpperSnackbar().showWarning(
                context,
                message:
